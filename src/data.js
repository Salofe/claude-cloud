...
const DEPOT = { iron: 0.6, ice: 0.6, titanium: 0.6, nickel: 0.6, he3: 0.6, platinum: 0.6, iridium: 0.6, exotic: 0.6 };
const LOCS = [
  ...
  { id: 'venus', n: 'Venus', r: 98, period: 120, a0: 2.7, size: 8, tex: 'venus', col: ['#f3d9a0', '#a8793b'], faction: 'tierra', danger: 0.04, tier: 5,
    ...
    market: { iron: 1.8, ice: 3.2, titanium: 2.0, platinum: 2.4, food: 2.2, machinery: 2.4, tech: 0.5, meds: 0.45, luxury: 0.45 },
  ...
  { id: 'tierra', n: 'Earth', r: 142, period: 190, a0: 0.2, size: 9, tex: 'earth', col: ['#5fb4ff', '#15407e'], faction: 'tierra', danger: 0.03, tier: 2,
    ...
    market: { iron: 2.4, nickel: 2.3, ice: 1.6, titanium: 2.5, platinum: 2.6, he3: 2.8, iridium: 2.4, exotic: 2.4, food: 0.45, meds: 0.5, machinery: 0.8, tech: 0.45, arms: 1.6, luxury: 1.2 },
  ...
  { id: 'marte', n: 'Mars', r: 196, period: 330, a0: 4.1, size: 7, tex: 'mars', col: ['#ff8a5c', '#7a2a14'], faction: 'marte', danger: 0.05, tier: 3,
    ...
    market: { iron: 2.0, nickel: 2.1, ice: 3.8, titanium: 2.2, platinum: 2.2, he3: 2.4, iridium: 2.2, food: 2.6, meds: 2.0, machinery: 0.45, tech: 2.0, arms: 0.4, luxury: 2.2 },
  ...
  { id: 'ceres', n: 'Ceres', r: 262, period: 560, a0: 5.4, size: 5, tex: 'rock', col: ['#b7b0a4', '#4c463e'], faction: 'cinturon', danger: 0.22, tier: 4,
    ...
    market: { iron: 0.7, nickel: 0.75, ice: 1.4, titanium: 0.75, platinum: 0.8, he3: 0.9, iridium: 0.8, food: 2.6, meds: 2.2, machinery: 2.2, tech: 2.4, arms: 2.0, luxury: 2.4 },
  ...
  { id: 'europa', n: 'Europa', parent: 'jupiter', r: 30, period: 11, a0: 0, size: 4, tex: 'europa', col: ['#f2eadb', '#8f7a60'], faction: 'exterior', danger: 0.12, tier: 6,
    ...
    market: { iron: 2.2, nickel: 2.2, ice: 0.6, titanium: 2.0, platinum: 2.2, he3: 1.4, iridium: 3.0, exotic: 2.2, food: 3.0, meds: 2.6, machinery: 2.4, tech: 2.6, arms: 2.0, luxury: 2.6 },
  ...
  { id: 'titan', n: 'Titan', parent: 'saturno', r: 32, period: 16, a0: 2, size: 5, tex: 'titan', col: ['#f0a95c', '#7a4a1c'], faction: 'exterior', danger: 0.12, tier: 7,
    ...
    market: { iron: 2.2, nickel: 2.2, ice: 1.0, titanium: 2.1, platinum: 2.3, he3: 3.2, iridium: 2.4, exotic: 2.6, food: 2.8, meds: 2.6, machinery: 0.5, tech: 2.8, arms: 2.2, luxury: 1.8 },
  ...
  { id: 'pluton', n: 'Pluto', r: 540, period: 2800, a0: 5.9, size: 5, tex: 'pluto', col: ['#e6d2bf', '#5a463c'], faction: 'piratas', danger: 0.3, tier: 8, black: 1,
    ...
    market: { iron: 1.8, nickel: 1.8, ice: 1.6, titanium: 1.9, platinum: 2.0, he3: 2.0, iridium: 2.8, exotic: 3.5, food: 3.0, meds: 3.2, tech: 2.6, arms: 0.45, luxury: 3.0, machinery: 2.4 },
...
const UNLOCKS = [
  ...
  { at: 15000, icon: '🔴', title: 'Mars & Mercury', text: '<b>Mercury</b> is covered in <b>Platinum</b> (worth 60× iron) but the heat burns your hull — buy <b>Shields</b>. <b>Mars</b> pays a fortune for ice.', upg: ['shield'] },
  { at: 500000, icon: '☄️', title: 'The Asteroid Belt', text: '<b>Ceres</b> and the Main Belt: nickel, platinum, iridium… and <b>pirates</b>. You fly and shoot in battle — buy <b>Weapons</b>!', upg: ['weapons'] },
...
const PROJECTS = [
  ...
  { id: 'fleet', icon: '🛡️', n: 'Private Security Fleet', loc: null, stage: 4, cost: 10e6, infl: 5,
